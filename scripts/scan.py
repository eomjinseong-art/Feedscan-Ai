...
def main():
    ...
    # ============================================================
    # 1. 한국 수집 (필터 없이 전체 검색 → duration으로 쇼츠/영상 분류)
    # ============================================================
    print("=== KR COLLECTION ===")
    ...
    # ============================================================
    # 2. 글로벌(US) 수집 (필터 없이 전체 검색 → duration으로 분류)
    # ============================================================
    print("\n=== US COLLECTION ===")
    ...
    # ============================================================
    # 3. AI Tool 수집 (필터 없이 전체 검색 → duration으로 분류)
    # ============================================================
    print("\n=== AI TOOL COLLECTION ===")
    aitool_shorts = {}
    aitool_videos = {}
